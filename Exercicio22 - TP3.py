...
class Game():
    ...
    def __init__(self,line_thickness=10,speed=5):
        ...
        self.speed = speed
        self.score = 0
        self.somPalheta = pygame.mixer.Sound("Som\paddle.wav")
        self.somVitoria = pygame.mixer.Sound("Som\win.wav")
        self.somLose = pygame.mixer.Sound("Som\lose.wav")
        self.somPonto = pygame.mixer.Sound("Som\score.wav")
        self.verificaPonto = True
    ...
    def update(self):
        ...
        if self.ball.hit_paddle(self.paddles['computer']):
            ...
            self.score = 0
            self.somLose.play()
        if self.score % 2 == 0 and self.score % 5 == 0 and self.score !=0:
            if self.verificaPonto:
                self.somPonto.play()
                self.verificaPonto = False
        else:
            self.verificaPonto = True   
